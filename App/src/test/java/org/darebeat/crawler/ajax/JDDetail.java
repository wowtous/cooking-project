package org.darebeat.crawler.ajax;
...
public class JDDetail implements HtmlBean {
	...
	public static void main(String[] args) throws Exception {
		HttpRequest request = new HttpGetRequest("https://item.jd.com/3903644.html");
		request.setCharset("GBK");
		GeccoEngine.create()
				.classpath("org.darebeat.crawler.ajax")
				//开始抓取的页面地址
				.start(request)
				//开启几个爬虫线程
				.thread(1)
