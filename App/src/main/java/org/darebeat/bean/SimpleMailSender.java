...
public class SimpleMailSender {
    ...
    private static SimpleMailSender service = null; // 服务邮箱
     ...
     * @return 邮箱服务
     */
    public static SimpleMailSender getSender(final String username, final String password) {
        if (service == null) {
            service = new SimpleMailSender(username, password);
        }
        return service;
    }
